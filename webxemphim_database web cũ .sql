...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2024 lúc 04:32 PM
...
CREATE TABLE `links` (
  ...
  `link2` longtext COLLATE utf8mb4_unicode_ci,
  `link3` longtext COLLATE utf8mb4_unicode_ci,
  `link4` longtext COLLATE utf8mb4_unicode_ci,
  `link5` longtext COLLATE utf8mb4_unicode_ci,
  `link6` longtext COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
